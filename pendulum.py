...
def main():
    ...
    # cv.imshow('pendulum_left', pendulum_left)
    # cv.imshow('pendulum_right', pendulum_right)

    final_image, list_kp1, list_kp2 = getMatchingFeature(pendulum_left, pendulum_right)
    ...
    # R1 = np.identity(3)
    # C1= np.zeros((3, 1))
    # R1 = rotationMatrixToEulerAngles(R1)
    # R1 = np.rad2deg(R1)
    # plt.scatter(x3D_set[0], x3D_set[2], s=1)
    # plt.plot(
    #         C[0],
    #         C[2],
    #         marker=(3, 0, int(R[1])),
    ...
    pendulum_left_epiline,_ = drawlines(pendulum_left_copy,pendulum_right_copy, lines1, list_kp1, list_kp2)
    pendulum_right_epiline,_ = drawlines(pendulum_right_copy, pendulum_left_copy, lines2, list_kp2, list_kp1)
